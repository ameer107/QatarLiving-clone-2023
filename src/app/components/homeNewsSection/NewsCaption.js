                ...
                <div className='lg:flex'>
                    {
                        newsCaption.captioTitles.map((news, index) => (
                            <div className='lg:px-[15px] lg:w-[25%] w-[100%] mb-[15px] max-mdl:border-b-[1px] max-mdl:border-qatar_border'>
                                <p>
                                    <Link href={news.title_href}
                                    className='text-[13px] text-[#222] leading-[1.3rem] font-semibold'
                                    >
                                        {news.title}
                                    </Link>
                                </p>
